...
export CFLAGS="-I$CURDIR/libtiff/$ARCH/deploy/usr/local/include -fno-omit-frame-pointer `pkg-config --cflags-only-other $CURDIR/libtiff/$ARCH/deploy/usr/local/lib/pkgconfig/libtiff-4.pc`"
